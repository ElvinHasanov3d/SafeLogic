 ...
 * This file demonstrates how to integrate Safelogic with a web frontend
 */

// For React/Vue/Angular applications
export class SafelogicClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SafelogicClient(provider, contractAddress);
